...
Page({
  ...
  selectDefult: function(event){
    ...
    console.log(id)
    wx.request({
      url: app.globalData.hostname +'home/index/set_address',
      data:{
        id: id,
  ...
  getIdentity: function(){
    let that = this
    wx.request({
      url: app.globalData.hostname + 'home/index/address_all',
      data: {
        openid: that.data.openId
      },
      success: function (res) {
  ...
  delete: function(event){
    ...
    that = this
    wx.request({
      url: app.globalData.hostname+'home/index/del_address',
      data:{
        openid: that.data.openId,
        id: id
      },
